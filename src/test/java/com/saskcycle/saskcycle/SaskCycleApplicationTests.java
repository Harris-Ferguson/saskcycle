...
//    tags2.add(Tags.Clothing.label);
    tags2.add(Tags.Electronics.label);
    tags2.add(Tags.SmallAppliances.label);
//    tags2.add(Tags.Toys.label);
//    tags2.add(Tags.HomeIndoor.label);
//    tags2.add(Tags.SportingGoods.label);
    tags2.add(Tags.HomeOutdoor.label);
    tags2.add(Tags.Furniture.label);
    tags2.add(Tags.Cookware.label);
    tags2.add(Tags.Transportation.label);
    tags2.add(Tags.LargeAppliances.label);
    Baccess.addBusiness(new Business("[Business] BN Metals","We take scrap metal, appliances (large and small), old bikes, and whatever metal you got.",
            "3","S7K1W4",tags2,false,-106.599226,52.139204));
  }
